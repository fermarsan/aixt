# module microchip.pic12_pwm.pwm
...
## Constants
```v
const ch1 = 0b11111_01_1 // PWM channels
```

[[Return to contents]](#Contents)

```v
const ch2 = 0b11111_10_1 // for both use pwm.ch1 & pwm.ch2
```

[[Return to contents]](#Contents)

```v
const f_high = 0b000000_00 // PWM frequency div by 1
```
