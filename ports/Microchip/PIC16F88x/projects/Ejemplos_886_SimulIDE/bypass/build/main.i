...
TRISAbits.TRISA0 = 1;
ANSEL = (uint8_t)~0b1111111111111110; ANSELH = (uint8_t)(~0b1111111111111110>>8); ADCON1 = 0b00000000; ADCON1bits.ADFM = 0; ADCON0bits.ADCS = 2; ADCON0bits.ADON = 1;;
TRISB = 0x00;
unsigned char muestra = 0;
while(1) {
muestra = adc__read_byte(0);
PORTB = (uint8_t)muestra;
}
}
