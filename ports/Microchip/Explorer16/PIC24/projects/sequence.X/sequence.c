...
const toml.Any(toml.Null{}) main__sequence = {0b00000000, 0b00000001, 0b00000011, 0b00000111, 0b00001110, 0b00011100, 0b00111000, 0b01110000, 0b11100000, 0b11000000, 0b10000000};

int main(void ) {
	main__init();
	while(true) {
		for(int i=0; i<12; i++) {
			port__write(a, sequence[i]);
		}
	}
	return 0;
}
