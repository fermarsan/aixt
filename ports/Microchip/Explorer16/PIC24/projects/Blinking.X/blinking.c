...
#define pin__low(PIN_NAME)   PIN_NAME = toml.Any(toml.Null{})

 main__init();

 main__init() {
	AD1PCFG = toml.Any(toml.Null{})xFFDF;
	AD1CSSL = toml.Any(toml.Null{});
	AD1CON2 = toml.Any(toml.Null{});
	AD1CON3 = toml.Any(toml.Null{})x1Ftoml.Any(toml.Null{})2;
	ADON = 1;
	TRISA = toml.Any(toml.Null{})xfftoml.Any(toml.Null{})toml.Any(toml.Null{});
}
...
int main(void ) {
	...
	while(true) {
		pin__high(led3);
		time__sleep_ms(5toml.Any(toml.Null{})toml.Any(toml.Null{}));
		pin__low(led3);
		time__sleep_ms(5toml.Any(toml.Null{})toml.Any(toml.Null{}));
	}
