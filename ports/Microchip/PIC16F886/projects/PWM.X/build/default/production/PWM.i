...
void main(void) {
    ...
    PR2 = 0x3E; CCPR2L = 0; TRISCbits.TRISC1 = 0; T2CON = 0b00000011; CCP2CON = 0b00001100; TMR2 = 0; T2CONbits.TMR2ON = 1;;

    while(1){

        ADCON0bits.CHS = 2; adc_reading();
        adc = adc_reading();

        { unsigned int pwm; pwm = ((adc - 0) * (60 - 0) / (256 - 0) + 0); CCPR2L = (pwm >> 2); };
