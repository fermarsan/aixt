...
EECON2 equ 018Dh ;# 
	...
	FNCALL	_main,_pwm__setup
	FNCALL	_main,_pwm__write
	FNCALL	_pwm__write,___wmul
	FNCALL	_main__init,_adc__init
	FNCALL	_main__init,_pwm__init
	FNROOT	_main
	global	_ADCON0
_ADCON0	set	0x1F
	global	_T2CONbits
...
; #config settings
	...
	config BOR4V = "BOR40V"
	config WRT = "OFF"
	file	"dist/default/production\PWM.X.production.s"
	line	#
...
??_adc__init:	; 1 bytes @ 0x0
?_pwm__init:	; 1 bytes @ 0x0
??_pwm__init:	; 1 bytes @ 0x0
?_main__init:	; 1 bytes @ 0x0
??_main__init:	; 1 bytes @ 0x0
?_pwm__setup:	; 1 bytes @ 0x0
??_pwm__setup:	; 1 bytes @ 0x0
?_main:	; 1 bytes @ 0x0
	global	?_adc__read
...
___wmul@product:	; 2 bytes @ 0x4
	ds	2
?_pwm__write:	; 1 bytes @ 0x6
	global	pwm__write@duty
pwm__write@duty:	; 2 bytes @ 0x6
	ds	2
??_pwm__write:	; 1 bytes @ 0x8
	ds	2
	global	pwm__write@pwm
pwm__write@pwm:	; 2 bytes @ 0xA
	ds	2
??_main:	; 1 bytes @ 0xC
	global	main@x
main@x:	; 2 bytes @ 0xC
...
;; *************** function _main *****************
;; Defined at:
;;		line 126 in file "pwm.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  x               2   12[COMMON] unsigned short 
...
l747:	
	movf	(main@x+1),w
	movwf	(pwm__write@duty+1)
	movf	(main@x),w
	movwf	(pwm__write@duty)
	fcall	_pwm__write
	goto	l743
	global	start
	ljmp	start
...
;; *************** function _pwm__write *****************
;; Defined at:
;;		line 121 in file "pwm.c"
;; Parameters:    Size  Location     Type
;;  duty            2    6[COMMON] unsigned short 
;; Auto vars:     Size  Location     Type
;;  pwm             2   10[COMMON] unsigned short 
;; Return value:  Size  Location     Type
;;                  1    wreg      void 
;; Registers used:
;;		wreg, status,2, status,0, pclath, cstack
...
psect	text1,local,class=CODE,delta=2,merge=1,group=0
	line	121
global __ptext1
__ptext1:	;psect for function _pwm__write
psect	text1
	file	"pwm.c"
	line	121
...
;incstack = 0
	callstack 6
; Regs used in _pwm__write: [wreg+status,2+status,0+pclath+cstack]
	line	122
	
l729:	
	movf	(pwm__write@duty+1),w
	movwf	(___wmul@multiplier+1)
	movf	(pwm__write@duty),w
	...
	fcall	___wmul
	movf	(0+?___wmul),w
	movwf	(??_pwm__write+0)+0
	movf	(1+?___wmul),w
	movwf	((??_pwm__write+0)+0+1)
	movf	(??_pwm__write+0)+1,w
	movwf	(??_pwm__write+0)+0
	clrf	(??_pwm__write+0)+1
	movf	0+(??_pwm__write+0)+0,w
	movwf	(pwm__write@pwm)
	movf	1+(??_pwm__write+0)+0,w
	movwf	(pwm__write@pwm+1)
	line	123
	
l731:	
	movf	(pwm__write@pwm+1),w
	movwf	(??_pwm__write+0)+0+1
	movf	(pwm__write@pwm),w
	movwf	(??_pwm__write+0)+0
	clrc
	rrf	(??_pwm__write+0)+1,f
	rrf	(??_pwm__write+0)+0,f
	clrc
	rrf	(??_pwm__write+0)+1,f
	rrf	(??_pwm__write+0)+0,f
	movf	0+(??_pwm__write+0)+0,w
...
l49:	
	return
	callstack 0
GLOBAL	__end_of_pwm__write
	__end_of_pwm__write:
	signat	_pwm__write,4217
	global	___wmul
...
;; *************** function _pwm__setup *****************
;; Defined at:
;;		line 111 in file "pwm.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text3,local,class=CODE,delta=2,merge=1,group=0
	...
	line	111
global __ptext3
__ptext3:	;psect for function _pwm__setup
psect	text3
	file	"pwm.c"
	line	111
...
;incstack = 0
	callstack 7
; Regs used in _pwm__setup: [wreg+status,2]
	line	112
...
l46:	
	return
	callstack 0
GLOBAL	__end_of_pwm__setup
	__end_of_pwm__setup:
	signat	_pwm__setup,89
	global	_main__init

;; *************** function _main__init *****************
;; Defined at:
;;		line 91 in file "pwm.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text4,local,class=CODE,delta=2,merge=1,group=0
	line	91
global __ptext4
__ptext4:	;psect for function _main__init
psect	text4
	file	"pwm.c"
	line	91
...
psect	text5,local,class=CODE,delta=2,merge=1,group=0
	line	108
global __ptext5
__ptext5:	;psect for function _pwm__init
psect	text5
	file	"pwm.c"
	line	108
...
;incstack = 0
	callstack 6
; Regs used in _pwm__init: []
	line	109
	
l43:	
	return
	callstack 0
GLOBAL	__end_of_pwm__init
	__end_of_pwm__init:
	signat	_pwm__init,89
	global	_adc__init

;; *************** function _adc__init *****************
;; Defined at:
;;		line 97 in file "pwm.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text6,local,class=CODE,delta=2,merge=1,group=0
	line	97
global __ptext6
__ptext6:	;psect for function _adc__init
psect	text6
	file	"pwm.c"
	line	97
...
psect	text7,local,class=CODE,delta=2,merge=1,group=0
	line	100
global __ptext7
__ptext7:	;psect for function _adc__read
psect	text7
	file	"pwm.c"
	line	100
