...
# 1970 "/opt/microchip/xc8/v3.00/pic/include/pic_chip_select.h" 3
# 1 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 1 3
# 50 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 157 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 208 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 270 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 304 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 382 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 452 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 496 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 558 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 602 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
extern volatile unsigned char EECON2 __attribute__((address(0x089)));

__asm("EECON2 equ 089h");
# 619 "/opt/microchip/xc8/v3.00/pic/include/proc/pic16f84.h" 3
...
# 1971 "/opt/microchip/xc8/v3.00/pic/include/pic_chip_select.h" 2 3
 ...
 *(&PORTA + (12 >> 3)) &= ~(0x01 << (12 - ((12 >> 3) << 3)));
 if( 1 == 1 ) { *(&TRISA + (8 >> 3)) |= (0x01 << (8 - ((8 >> 3) << 3))); } else { *(&TRISA + (8 >> 3)) &= ~(0x01 << (8 - ((8 >> 3) << 3))); };;
 INTEDG = 0;
 GIE = 1; INTE = 1;;
 while( 1 ) {
 }
