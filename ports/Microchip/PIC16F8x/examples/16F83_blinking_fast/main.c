...
#define pin__toggle_fast(port_name, pin_number) TOGGLE_FAST(port_name, pin_number)
...
#define pin__write_fast(port_name, pin_number, value) WRITE_FAST(port_name, pin_number, value)

#define pin__setup_fast(port_name, pin_number, mode) SETUP_FAST(port_name, pin_number, mode)

#define pin__low_fast(port_name, pin_number) LOW_FAST(port_name, pin_number)
...
#define pin__high_fast(port_name, pin_number) HIGH_FAST(port_name, pin_number)

#define pin__read_fast(port_name, pin_number)  READ_FAST(port_name, pin_number)
...
#define _const_main__cpu_freq 20000000
 ...
 void main(void) {
	pin__setup_fast(_const_pin__port_b, 4, _const_pin__output); 
	while( true ) {
		pin__high_fast(_const_pin__port_b, 4); 
		time__sleep_ms(250); 
		pin__low_fast(_const_pin__port_b, 4); 
		time__sleep_ms(250); 
	} 
}
