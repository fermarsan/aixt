...
#define fast__read(port_name, pin_number)  READ_FAST(port_name, pin_number)

#define fast__toggle(port_name, pin_number) TOGGLE_FAST(port_name, pin_number)

#define fast__low(port_name, pin_number) LOW_FAST(port_name, pin_number)

#define fast__write(port_name, pin_number, value) WRITE_FAST(port_name, pin_number, value)

#define fast__setup(port_name, pin_number, mode) SETUP_FAST(port_name, pin_number, mode)

#define fast__high(port_name, pin_number) HIGH_FAST(port_name, pin_number)
...
#define _const_main__cpu_freq 20000000
 ...
 void main(void) {
	pin__fast__setup(pin__port_b, 4, pin__output); 
	while( true ) {
		pin__fast__high(pin__port_b, 4); 
		time__sleep_ms(250); 
		pin__fast__toggle(pin__port_b, 4); 
		time__sleep_ms(250); 
	} 
}
