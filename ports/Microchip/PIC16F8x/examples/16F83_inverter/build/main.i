...
# 2754 "/opt/microchip/xc8/v2.46/pic/include/pic_chip_select.h" 3
# 1 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 1 3
# 44 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
# 1 "/opt/microchip/xc8/v2.46/pic/include/__at.h" 1 3
# 45 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 2 3
...
# 159 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 210 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 272 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 306 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 384 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 454 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 498 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 560 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 604 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
extern volatile unsigned char EECON2 __attribute__((address(0x089)));

__asm("EECON2 equ 089h");
# 621 "/opt/microchip/xc8/v2.46/pic/include/proc/pic16f83.h" 3
...
# 2755 "/opt/microchip/xc8/v2.46/pic/include/pic_chip_select.h" 2 3
...
# 87 "main.c"
void main(void) {
 if(pin__input == 1) { *(&TRISA + (pin__b3 >> 3)) |= (0x01 << (pin__b3 - ((pin__b3 >> 3) << 3))); } else { *(&TRISA + (pin__b3 >> 3)) &= ~(0x01 << (pin__b3 - ((pin__b3 >> 3) << 3))); };;
 if(pin__output == 1) { *(&TRISA + (pin__b4 >> 3)) |= (0x01 << (pin__b4 - ((pin__b4 >> 3) << 3))); } else { *(&TRISA + (pin__b4 >> 3)) &= ~(0x01 << (pin__b4 - ((pin__b4 >> 3) << 3))); };;
 while(1) {
  *(&PORTA + (pin__b4 >> 3)) &= (~(0x01 << (pin__b4 - ((pin__b4 >> 3) << 3)))); *(&PORTA + (pin__b4 >> 3)) |= (~(unsigned char)((*(&PORTA + (pin__b3 >> 3)) >> (pin__b3 - ((pin__b3 >> 3) << 3))) & 0x01) << (pin__b4 - ((pin__b4 >> 3) << 3)));;
 }
}
