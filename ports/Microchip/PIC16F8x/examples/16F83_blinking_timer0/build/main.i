...
# 2774 "/opt/microchip/xc8/v2.50/pic/include/pic_chip_select.h" 3
# 1 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 1 3
# 44 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
# 1 "/opt/microchip/xc8/v2.50/pic/include/__at.h" 1 3
# 45 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 2 3
...
# 159 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 210 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 272 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 306 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 384 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 454 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 498 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 560 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 604 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
extern volatile unsigned char EECON2 __attribute__((address(0x089)));

__asm("EECON2 equ 089h");
# 621 "/opt/microchip/xc8/v2.50/pic/include/proc/pic16f83.h" 3
...
# 2775 "/opt/microchip/xc8/v2.50/pic/include/pic_chip_select.h" 2 3
...
void main(void) {
 ...
 timer0__prescaler = (i8)((i8)(7)); timer0__initial = (i8)((i8)(-1)); while( (timer0__initial < 0 || timer0__initial > 127) && timer0__prescaler >= 0 ) { timer0__prescaler--; timer0__initial = (i8)((i8)(256 - (20000 * 4000000/1000000) / (4 * (1 << (timer0__prescaler + 1))))); } T0CS = 0; if( timer0__prescaler == -1 ) { PSA = 1; } else { PSA = 0; OPTION_REG &= 0b11111000; OPTION_REG |= timer0__prescaler; }; TMR0 = (u8)(timer0__initial);;
 *(&PORTA + (12 >> 3)) &= ~(0x01 << (12 - ((12 >> 3) << 3)));
 GIE = 1; T0IE = 1;;
 while( 1 ) {
 }
