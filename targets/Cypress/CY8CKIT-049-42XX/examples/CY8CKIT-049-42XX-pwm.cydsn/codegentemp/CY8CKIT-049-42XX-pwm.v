// ======================================================================
// CY8CKIT-049-42XX-pwm.v generated from TopDesign.cysch
// 07/15/2025 at 14:04
...
module top ;
	...
	wire [0:0] tmpOE__pwm_0_net;
	wire [0:0] tmpFB_0__pwm_0_net;
	wire [0:0] tmpIO_0__pwm_0_net;
	wire [0:0] tmpINTERRUPT_0__pwm_0_net;
	electrical [0:0] tmpSIOVREF__pwm_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		pwm_0
		 (.oe(tmpOE__pwm_0_net),
		  .y({Net_69}),
		  .fb({tmpFB_0__pwm_0_net[0:0]}),
		  .io({tmpIO_0__pwm_0_net[0:0]}),
		  .siovref(tmpSIOVREF__pwm_0_net),
		  .interrupt({tmpINTERRUPT_0__pwm_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pwm_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
