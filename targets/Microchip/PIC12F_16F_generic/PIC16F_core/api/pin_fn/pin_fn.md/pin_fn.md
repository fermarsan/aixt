...
setup function configures the mode of a pin. `id` is the pin id for example `pin.c7` `mode` is the pin mode, `pin.input` or `pin.output`
...
#### Powered by vdoc. Generated on: 28 Dec 2025 12:41:06
