...
@[as_macro] pub const a0 = u8(0) // PORTA pins
...
@[as_macro] pub const b0 = u8(8) // PORTB pins
...
@[as_macro] pub const c0 = u8(16) // PORTC pins
...
@[as_macro] pub const d0 = u8(24) // PORTA pins
...
// IRQ (INT) pin
@[as_macro] pub const irq = u8(8) // RB0/INT
