...
fn C.HIGH_FAST(port_id any, pin_id any)
fn C.LOW_FAST(port_id any, pin_id any)
fn C.READ_FAST(port_id any, pin_id any) u8
fn C.SETUP_FAST(port_id any, pin_id any, mode u8)
fn C.TOGGLE_FAST(port_id any, pin_id any)
fn C.WRITE_FAST(port_id any, pin_id any, value u8)
...
@[as_macro]
pub fn high(port_id any, pin_id any) {
...
@[as_macro]
pub fn low(port_id any, pin_id any) {
...
// `pin_id` is the pin id, for example `pin_fast.b3`
@[as_macro]
pub fn read(port_id any, pin_id any) u8 {
...
@[as_macro]
pub fn setup(port_id any, pin_id any, mode u8) {
...
// `pin_id` is the pin id, for example `pin_fast.b3`
@[as_macro]
pub fn toggle(port_id any, pin_id any) {
...
// `pin_id` is the pin id, for example `pin_fast.b3`
@[as_macro]
pub fn write(port_id any, pin_id any, value u8) {
