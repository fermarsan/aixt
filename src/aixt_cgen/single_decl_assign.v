	...
	match var_kind {		
		'array', 'array_fixed' {
			...
			if array_init.is_fixed {
				out << $tmpl('c_templates/decl_assign_array_fixed.c')#[..-1]
			} else {
				out << $tmpl('c_templates/decl_assign_array.c')#[..-1]
			}
		}
		'string' {
